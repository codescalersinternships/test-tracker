...
from server.test_tracker.services.requirement import get_project_requirement_by_id, get_requirement_by_id
...
class ProjectRequirementsHandling():
    ...
    def validate(project_id:str, requirement_id:str):
        ...
        if project_requirement is None:
            return CustomResponse.not_found(message = "Project Requirement does not exist")
...
class RequirementHandling():
    ...
    def validate(project_id:str, project_requirement_id:str, requirement_id:str):
        ...
        if project_requirement.project != project or requirement.requirement != project_requirement:
            return CustomResponse.bad_request(
                message="You don't have permission to access this test plan"
            )
