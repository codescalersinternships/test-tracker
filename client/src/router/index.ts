...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/projects/:project-id/test-plan', name: 'testPlans', component: () => import('@/pages/test-plans/TestPlansView.vue') },
    { path: '/projects/:project-id/requirement', name: 'testRequirements', component: () => import('@/pages/test-requirements/TestRequirementsView.vue') },
    { path: '/projects/:project-id/test-suite', name: 'testSuites', component: () => import('@/pages/test-suites/TestSuitesView.vue') },
    { path: '/projects/:project-id/test-run', name: 'testRuns', component: () => import('@/pages/test-runs/TestRunsView.vue') },
    { path: '/projects/:project-id/test-plan/:id', name: 'testPlan', component: () => import('@/pages/test-plans/TestPlanDetailsView.vue') },
    { path: '/projects/:project-id/requirement/:id', name: 'testRequirement', component: () => import('@/pages/test-requirements/TestRequirementDetailsView.vue') },
