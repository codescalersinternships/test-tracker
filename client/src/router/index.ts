...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/projects/:id/test-plan', name: 'testPlan', component: () => import('@/pages/test-plans/TestPlansView.vue') },
    { path: '/projects/:id/requirement', name: 'testRequirement', component: () => import('@/pages/requirements/RequirementsView.vue') },
    { path: '/projects/:id/test-suite', name: 'testSuite', component: () => import('@/pages/test-suites/TestSuitesView.vue') },
    { path: '/projects/:id/test-run', name: 'testRun', component: () => import('@/pages/test-runs/TestRunsView.vue') },
