<script>
    ...
    onMount(async () => {
        const testRunDetails = await axios.get(`/test_runs/projects/${projectID}/runs/${testRunID}/`, config);
        ...
        <div class="container pt-4 pb-4">
            {#if testRun}
                <div class="">
                    ...
                    <p class="text-muted">
                        -- Contains a total of <strong class="text-dark">{testSuites.length}</strong> 
                                    ...
                                    <div class="test_case_card">
                                        ...
                                        <div class="test_case_info">
                                            ...
                                            <div class="row" style="margin-left: 10px;">
                                                <div class="col-3"><small>Created on</small></div>
                                                <div class="col-3"><small>Updated on</small></div>
                                                <div class="col-3"><small>Total test cases</small></div>
                                                <div class="col-3"><small>Test Plan</small></div>
            
                                                <div class="col-3"><strong><small>{suite.created}</small></strong></div>
                                                <div class="col-3"><strong><small>{suite.modified}</small></strong></div>
                                                <div class="col-3"><strong><small>{suite.number_of_test_cases}</small></strong></div>
                                                                    ...
                                                                    <small>
                                                                        {
                                                                            ...
                                                                            suite.test_plan.title.slice(0,25)+'..' : suite.test_plan.title
                                                                        }
                                                                    </small>
                                                                {/if}
                                                            </a>
                                            ...
                                            <div class="collapse collapse-style" id="collapse-{suite.id}">
                                                <div class="row">
                                                    <div class="col-3"><small style="color:#7fb24b">Passed</small></div>
                                                    <div class="col-3"><small style="color:#f1495d">Failed</small></div>
                                                    <div class="col-3"><small style="color:#f5a623;">Skipped</small></div>
                                                    <div class="col-3"><small style="color:#5a79b1">Not Run</small></div>
                
                                                    <div class="col-3">
                                                        <strong>
                                                            <span class="number pass"></span>
                                                    ...
                                                    <div class="col-3">
                                                        <strong>
                                                            <span class="number skip"></span>
                                                            <small>{suite.skipped}</small>
                                                        </strong>
                                                    </div>
                                                    <div class="col-3">
                                                        <strong>
                                                            <span class="number not_run"></span>
                                ...
                                <div class="card-body pb-4">
                                    <div class="row">
                                        <div class="col-3 report-graid">
                                            <span class="pass report-span-style">{testRun.passed}</span>
                                            <span class="report-span-text" style="color:#7fb24b">Passed</span>
                                        </div>
                                        <div class="col-3 report-graid">
                                            <span class="fail report-span-style">{testRun.failed}</span>
                                            <span class="report-span-text" style="color:#f1495d">Failed</span>
                                        </div>
                                        <div class="col-3 report-graid">
                                            <span class="skip report-span-style">{testRun.skipped}</span>
                                            <span class="report-span-text" style="color:#f5a623;">Skipped</span>
                                        </div>
                                        <div class="col-3 report-graid">
                                            <span class="not_run report-span-style">{testRun.not_run}</span>
                                            <span class="report-span-text" style="color:#5a79b1">Not Run</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
