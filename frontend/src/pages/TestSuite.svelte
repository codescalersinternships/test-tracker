        ...
        <div class="container pt-4 pb-4">
                                ...
                                <div class="card-body pb-2">
                                    ...
                                    <div class="pt-4">
                                        <div class="row">
                                            ...
                                            >
                                                <p class="text-muted">
                                                    Number of test cases: <strong
                                                        >{suite.number_of_test_cases}</strong
                                                    >
                                                </p>
                                            </div>
                                        </div>
            ...
            {:else}
                <div class="col-12 pt-5">
                    <p class="text-muted">-- There are no test suites yet</p>
                </div>
            {/if}
        </div>
    {:else}
