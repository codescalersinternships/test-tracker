<script>
    ...
    export let endPoint = '/project/last-5-projects/';
    export let allOfProjects;
    ...
    onMount(async () => {
        ...
        const last5Projects = await axios.get(endPoint, config)
...
<div class="pt-5">
    ...
    <p class="last-projects">{pageTitle}</p>
    <div class="row p-1">
